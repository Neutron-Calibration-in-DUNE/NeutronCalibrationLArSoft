...
sed -e "s@REPLACE@$INPUT_FILE@" < $PROTODUNE_UNET_PATH/unet_generator.fcl > $PROTODUNE_UNET_PATH/temp_generator_$RUN_NUMBER.fcl

lar -n $NUM_EVENTS \
    -c $PROTODUNE_UNET_PATH/temp_generator_$RUN_NUMBER.fcl \
